function rtn_str = fstr(varargin)
%DISPL Displays a list of input variables
%
...
%	See also DISP.
	...
	if nargin == 0 %If not arguments, print a blank newline
		rtn_str = " "; %Display a space to print a new line
	else %Display the master string
		rtn_str = sprintf(disp_str); % The sprintf call allows \n to work.
	end
