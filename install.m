...
folders = ["DDF", "ddfload_Data", "electronics", "general", "import",  "RF", "Tutorials", "Smith Chart", fullfile("MSTD", "CLI"), fullfile("MSTD", "plotting"), fullfile("MSTD", "search"), fullfile("MSTD", "string_manipulation"), fullfile("MSTD", "system"), "FileExchange", "tome"];
